          ...
          return xe(
            ...
            t.map(function (e, t) {
              return e.map(function (e, r) {
                return xe(Le, { key: "".concat(t, "_").concat(r) }, e || "");
              });
            })
          );
        };
      Te.displayName = "Grid2048";
      var Me = i.a.createElement,
        Ae = function (e) {
          var t = (function (e) {
              var t,
                r = e.initialValues,
                n = Object(a.useReducer)(Se, ke(r)),
                o = n[0],
                i = n[1];
              Object(a.useEffect)(
                function () {
              ...
              return {
                ...
                cancelLastAction: s,
                canCancel: !!(null === (t = o.history) || void 0 === t
                  ? void 0
                  : t.length),
                continueGame: l,
                resetGame: c,
      ...
      function Be() {
        return We(
          ...
          We(
            ...
            null,
            We("title", null, "2048"),
            We("link", { rel: "icon", href: "/favicon.ico" })
          ),
          We(u, null),
          We(
            "main",
