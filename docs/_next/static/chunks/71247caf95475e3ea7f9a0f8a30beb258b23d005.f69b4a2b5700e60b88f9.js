      ...
      t.a = function (e) {
        ...
        function a(e, t, r, n, i, o, a, s, l, u) {
          for (var f, d = 0, h = t; d < R; ++d)
            switch ((f = j[d].call(c, e, h, r, n, i, o, a, s, l, u))) {
              case void 0:
              case !1:
              case !0:
              case null:
        ...
        function c(e, r) {
          ...
          var f = (function e(r, s, c, f, d) {
            for (
              ...
              if (
                ...
                switch (p) {
                  case 123:
                    for (
                      h = (G = G.trim()).charCodeAt(0), m = 1, L = ++M;
                      M < F;
                  ...
                  case 59:
                    if (
                      1 <
                      (L = (G = (0 < z ? G.replace(u, "") : G).trim()).length)
                    )
                      switch (
                        (0 === N &&
                          ((h = G.charCodeAt(0)),
                        ...
                        0 < R &&
                          void 0 !==
                            (w = a(1, G, s, r, P, O, H.length, f, d, f)) &&
                          0 === (L = (G = w.trim()).length) &&
                          (G = "\0\0"),
                        (h = G.charCodeAt(0)),
                        (p = G.charCodeAt(1)),
                ...
                case 10:
                  47 === C
                    ...
                    : 0 === 1 + h &&
                      ...
                      0 < G.length &&
                      ((z = 1), (G += "\0")),
                    0 < R * _ && a(0, G, s, r, P, O, H.length, f, d, f),
                    (O = 1),
                    P++;
                  break;
                case 59:
            ...
            if (0 < (L = H.length)) {
              if (
                ((z = s),
                0 < R &&
                  void 0 !== (w = a(2, H, z, r, P, O, L, f, d, f)) &&
                  0 === (H = w).length)
              )
                return Y + H + q;
              if (((H = z.join(",") + "{" + H + "}"), 0 !== E * I)) {
                switch ((2 !== E || i(H, 2) || (I = 0), I)) {
                  case 111:
          ...
          return (
            0 < R &&
              void 0 !== (c = a(-2, f, s, s, P, O, f.length, 0, 0, 0)) &&
              (f = c),
            "",
            (I = 0),
            (O = P = 1),
      ...
      (function (e) {
              ...
              if (a) {
                ...
                if (s) {
                  var c = 0 | parseInt(s[1], 10),
                    l = s[2];
                  0 !== c &&
                    (R(l, c), N(e, l, s[3]), e.getTag().insertRules(c, n)),
                    (n.length = 0);
                } else n.push(a);
              }
            }
        ...
        function te(e) {
          var t,
            ...
            p = function (e, n, o) {
              return (0 === n && ee.includes(o[r.length])) || o.match(i)
                ? e
                : "." + t;
            };
          function m(e, o, a, s) {
        ...
        function pe(e) {
          return ue.test(e) ? e.replace(fe, he).replace(de, "-ms-") : e;
        }
        var me = function (e) {
          return null == e || !1 === e || "" === e;
        };
        ...
        function Pe(e) {
          ...
          for (var i = 0, o = r; i < o.length; i++) {
            var a = o[i];
            if (Ae(a)) for (var s in a) xe(s) && Oe(e, a[s], s);
          }
          return e;
        }
        ...
        function Ee(e) {
          ...
          return e.children
            ? o.a.createElement(Ie.Provider, { value: r }, e.children)
            : null;
        }
        var Te = {};
        function je(e, t, r) {
              ...
              return (function (e, t, r, n) {
                ...
                for (var x in C)
                  "$" !== x[0] &&
                    ...
                    ("forwardedAs" === x
                      ? (A.as = C[x])
                      : (l ? l(x, u.a) : !k || Object(u.a)(x)) &&
                        (A[x] = C[x]));
                return (
                  t.style &&
                    g.style !== t.style &&
                    (A.style = h({}, t.style, {}, g.style)),
          ...
          return (
            ...
            (A.withComponent = function (e) {
              var n = t.componentId,
                ...
                o = n && n + "-" + (Ce(e) ? e : we(b(e)));
              return je(e, h({}, i, { attrs: k, componentId: o }), r);
            }),
